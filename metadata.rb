...
recipe "sys_firewall::import_rule_list",
  "Imports and applies firewall rules from a given local or remote file."
...
attribute "sys_firewall/enabled",
  ...
  :default => "enabled",
  :recipes => ["sys_firewall::default", "sys_firewall::import_rule_list"]
