...
# IP Tables target policy. e.g: DROP, REJECT, ACCEPT, LOG, QUEUE
attribute :target, :kind_of => String, :default => "ACCEPT"

# Firewall port
attribute :port, :kind_of => [Integer, String] # Can also be passed as resource name
